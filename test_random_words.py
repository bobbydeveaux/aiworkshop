...
class TestRandomWords(unittest.TestCase):
    ...
    def test_generate_10_words(self):
        """Test that generate_random_words returns exactly 10 words by default."""
        random_words = generate_random_words()
        self.assertEqual(len(random_words), 10, "Should generate exactly 10 words by default")
